...
const EmployerStat = ({ label, value, subtext, icon: Icon, delay }) => (
    <motion.div
...
const EmployerDashboard = () => {
    return (
        <div className="min-h-screen bg-slate-50 transition-colors duration-500 font-sans p-8 sm:p-12 lg:p-16 pt-32">
            ...
            <div className="max-w-7xl mx-auto space-y-10">
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 border-b border-slate-200 pb-10">
                    <div>
                        <div className="flex items-center gap-3 mb-6">
                            <span className="text-[10px] font-bold text-green-600 bg-green-50 px-3 py-1 rounded-full uppercase tracking-widest">Employer Protocol</span>
                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Talent Acquisition Layer</span>
                        </div>
                        <h1 className="text-5xl font-black text-slate-900 tracking-tight leading-none">
                            Talent <span className="text-green-600">Acquisition</span>
                        </h1>
                        <p className="text-slate-500 mt-4 font-medium italic">Architecting your team with surgical precision.</p>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <EmployerStat label="Active Roles" value="08." subtext="+2 Priority" icon={Briefcase} delay={0.1} />
                    <EmployerStat label="Talent Pool" value="1.2k" subtext="+18% Growth" icon={Users} delay={0.2} />
                    <EmployerStat label="Review Queue" value="12." subtext="4 Critical" icon={MessageSquare} delay={0.3} />
                    <EmployerStat label="Sync Rate" value="85%" subtext="On Target" icon={TrendingUp} delay={0.4} />
                </div>
